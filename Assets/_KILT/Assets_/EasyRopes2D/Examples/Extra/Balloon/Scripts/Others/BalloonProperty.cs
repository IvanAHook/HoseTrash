...
public class BalloonProperty : BlockSpecialProperty 
{
	...
	public void MarkToRecalcForce(bool p_force = true)
	{
		//if(p_force)
			_needRecalcForce = true;
		//else
		//	GlobalScheduler.CallFunction(this.gameObject, new Delegates.FunctionPointer(MarkToRecalcForce), 0.4f, false);
	}
	...
	{
		if(Application.isPlaying && !KiltUtils.IsPrefab(this.gameObject, PrefabSearchMethodEnum.Full))
		{
